export const PROMPTS = {
  ...
  """`,
    ...
    enhance_text: (text, lang) => `
  Improve the text under """""" by correcting grammar, refining word choice, and enhancing clarity and fluency. Keep the original meaning unchanged. Provide only the improved version as output, without any explanations or formatting. Output must be in ${lang}.
